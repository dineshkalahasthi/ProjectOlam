...
public class Test_Cart_ViewItem extends BaseDriver {

	public static String pageTitle = "Customer Login";
	public static String TC;
	public static String path;
	public static int statRow = 1;
	public static String Scenario = "Test_Cart_ViewItem";
	...
	public void TestOrderReviewProduct(String TcID, String TcRunnable)
		...
		APP_LOG.info("Selected ALMONDS from the Shop Menu");
		Thread.sleep(2000);
		almondsPage_Objects = new AlmondsPage_Objects(getDriver());
		almondsPage_Objects.ClickonsubProduct(PRODUCT);
		APP_LOG.info("Select the subproduct under the Almonds Section");
		...
		APP_LOG.info("Add the product to cart");
    	...
    	//APP_LOG.info("List of items added to the cart");
    	APP_LOG.info("Below is the list of items added to the cart");
    	shpCart.ValidateCartList();
