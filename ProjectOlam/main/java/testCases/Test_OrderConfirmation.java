...
public class Test_OrderConfirmation extends BaseDriver {
	...
	public static Success_PageObjects successpage;
	...
	public void TestOrderReviewProduct(String TcID, String TcRunnable)
		...
		APP_LOG.info("Executing Test ::: "+Scenario);
		...
		successpage=new Success_PageObjects(driver);
		...
		shpCart.ContinueShopping();
		secCheckout.clickAgreeTerms();
		secCheckout.placeOrder();		
		successpage.SuccessPageActions();
